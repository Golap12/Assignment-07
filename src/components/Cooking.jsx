...
const Cooking = ({ cooks, handleCook }) => {
    ...
    return (
        ...
        <div className='md:space-y-3 space-y-2 border p-5 rounded-xl'>
            ...
            <button onClick={() => handleCook(cooks)} className='hover:transition-all hover:bg-gray-400 md:px-5 px-3 md:py-2 py-1 rounded-full bg-green-400 font-bold text-sm'>Want to Cook</button>
        </div>
